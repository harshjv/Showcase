...
Route::post('add_check', array('before' =>'csrf', 'as' => 'add_check', 'uses' => 'ProjectController@addCheck'));
Route::post('add_project', array('before' =>'csrf', 'as' => 'do_add', 'uses' => 'ProjectController@doAdd'));
...
Route::post('edit_check', array('before' =>'csrf', 'as' => 'edit_check', 'uses' => 'ProjectController@editCheck'));
